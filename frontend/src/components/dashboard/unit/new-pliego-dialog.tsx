...
export function NewPliegoDialog({ onCreated }: NewPliegoDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="w-[min(56rem,calc(100vw-2rem))] max-w-none overflow-x-hidden rounded-[1.8rem] border border-[#ddd8de] bg-white p-0 shadow-[0_30px_80px_rgba(64,42,48,0.18)] [@media(max-height:900px)]:max-h-[88dvh] [@media(max-height:900px)]:overflow-y-auto sm:max-w-none">
