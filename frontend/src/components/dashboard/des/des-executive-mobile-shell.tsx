...
export function DESExecutiveMobileShell({
  ...
  return (
    <main className="mx-auto h-dvh min-h-dvh w-full max-w-full overflow-x-hidden overflow-y-auto overscroll-y-contain bg-[linear-gradient(180deg,#fff8fa_0%,#f7f1f4_34%,#eef4fb_100%)] px-4 py-3 pb-20 sm:max-w-md">
